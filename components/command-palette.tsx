...
const commands: CommandItem[] = [
  ...
  },
  {
    ...
    href: "/dashboard",
    keywords: ["dashboard", "home", "대시보드", "오늘"],
    scope: "학습",
  },
  {
    title: "내 과정",
    description: "수강 중인 과정과 과정별 학습 상태를 확인합니다.",
    href: "/my-courses",
    keywords: ["my courses", "enrollment", "내 과정", "수강"],
    scope: "학습",
  },
  {
    title: "문제풀이",
  ...
  },
  {
    ...
    description: "Concept, alias, edge, cross-course mapping을 검색합니다.",
    href: "/admin/ontology",
  ...
  },
  {
    ...
    description: "AI 응답의 Retrieval, Citation, Prompt, 비용 정보를 추적합니다.",
