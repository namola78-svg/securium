...
const guideSteps = [
  ...
  },
  {
    title: "3. 문제풀이와 오답 정리",
    description:
      "학습한 주제와 연결된 문제를 풀고, 틀린 문제는 오답노트에서 다시 확인합니다. 이용 가능한 기능과 학습 콘텐츠는 화면에서 명확히 구분됩니다.",
  },
  {
    title: "4. AI 튜터 활용",
    description:
      "AI 설명은 학습 보조 자료로 사용합니다. 공식 기준·법령·시험 채점 결과가 아니므로 중요한 판단은 최신 공식 자료와 함께 확인하세요.",
  },
];
        ...
        <div className="shell narrow">
          ...
          <div className="course-detail-section">
            ...
            <ul className="feature-list">
              ...
              <li>내 학습에 과정을 추가하고 커리큘럼 순서대로 학습합니다.</li>
              <li>문제풀이와 오답노트를 반복해 취약 영역을 줄입니다.</li>
              <li>AI 튜터 설명은 이해를 돕는 참고 자료로 활용합니다.</li>
            </ul>
          </div>
