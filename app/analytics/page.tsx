    ...
    <main className="page-main dashboard-page">
      <div className="shell">
        ...
        <Suspense fallback={<AnalyticsMetricsFallback />}>
          <AnalyticsMetrics analyticsPromise={analyticsPromise} />
        </Suspense>
...
function AnalyticsMetricsFallback() {
  return (
    <section className="stats-grid" aria-live="polite">
      <Metric label="수강 과정" value={0} unit="개" />
      <Metric label="누적 학습일" value={0} unit="일" />
      <Metric label="누적 문제" value={0} unit="개" />
      <Metric label="전체 정답률" value={0} unit="%" />
    </section>
  );
}
