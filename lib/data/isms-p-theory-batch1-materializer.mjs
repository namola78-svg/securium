...
export async function applyIsmsPBatch1Materialization(
  ...
  assertCs1aMaterializerFixtureBoundary(context);
...
function assertCs1aMaterializerFixtureBoundary(context = {}) {
  if (
    context.target !== "isolated-d1" ||
    context.environment !== "test" ||
    context.confirmation !== ISMS_P_BATCH1_WRITE_CONFIRMATION
  ) {
    throw materializerError(
      "CS1A_POLICY_REQUIRED",
      "Direct materialization requires an isolated test fixture; production and adapter writes must use the CS-1A mutation service.",
    );
  }
}
