...
| --- | ---: | ---: | ---: | ---: |
| 정보보안기사 | 77 | 18 | 11 | Content 23.4% / 문항 14.3% |
| 정보보안산업기사 | 62 | 17 | 10 | Content 27.4% / 문항 16.1% |
| 합계 | 139 | 35 | 21 | Content 25.2% / 문항 15.1% |
...
| 세부항목 / SUB_ITEM | 95 | 18 | 12 |

이 수치는 운영 DB 상태가 아니라 로컬 seed 코드 기준이다. 네트워크 보안은 주요항목 3개와 세부항목 9개가 기사·산업기사 양쪽 CourseLesson으로 분할되었고, 문항은 DoS/DDoS, 스캐닝, 스푸핑, 스니핑, 원격접속 공격, 네트워크 보안기술 이해 세부항목 Content에 연결되어 있다. 다음 콘텐츠 확장은 네트워크 보안 미연결 세부항목 문항 보강 또는 다른 과목의 `MAJOR_ITEM` 분할이다.
