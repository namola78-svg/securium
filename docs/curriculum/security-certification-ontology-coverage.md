...
- 현재 공식 과목·실기 개요와 네트워크·시스템보안·애플리케이션보안·정보보안일반·정보보호관리 및 법규·실기 주요/세부항목 CourseLesson seed는 131개 연결을 제공한다.
...
현재 로컬 계산 기준 linked curriculum node는 정보보안기사 72개, 정보보안산업기사 59개다. 운영 DB 상태가 아니라 seed 코드 기준이며, Production 반영은 별도 승인 절차가 필요하다.
