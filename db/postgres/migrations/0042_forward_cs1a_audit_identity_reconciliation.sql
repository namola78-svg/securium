-- Forward reconciliation: current CS1A audit identity authority.
-- No historical ledger adoption, audit-row backfill, or governance-history rewrite.
BEGIN;
...
VALUES ('0042_forward_cs1a_audit_identity_reconciliation', 'forward-cs1a-audit-identity-reconciliation-v1')
