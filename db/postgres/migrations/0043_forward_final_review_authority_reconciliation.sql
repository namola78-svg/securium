-- Forward reconciliation: current final review authority.
-- PostgreSQL-only current authority; no historical ledger adoption or row backfill.
BEGIN;
...
CREATE UNIQUE INDEX "content_final_review_authority_semantic_unique"
  ON public."content_final_review_authorities" ("semantic_decision_hash");
CREATE UNIQUE INDEX "content_final_review_authority_idempotency_unique"
  ON public."content_final_review_authorities" ("idempotency_key");
CREATE INDEX "content_final_review_authority_lookup_idx"
  ON public."content_final_review_authorities" ("candidate_identity", "resource_type", "scope", "authority_state");
...
CREATE INDEX "content_final_review_authority_subject_lookup_idx"
  ON public."content_final_review_authority_subjects" ("subject_identity", "semantic_ordinal");
...
VALUES ('0043_forward_final_review_authority_reconciliation', 'forward-final-review-authority-reconciliation-v1')
